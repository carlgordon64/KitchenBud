...
<div class="altbod">
  ...
  <a href="Edit_page_1.php"><div style="text-align:center; margin-top:10px; margin-left:20px;"><div style="padding-left:20px; width:632px; height:46px; border-radius:50px; display:inline-block; margin:auto; border:3px dashed #1b1f20;">
  </div></div></a>
  </div>
  <!--END Settings Page-->
<!--APPLICATION ROW 1-->
